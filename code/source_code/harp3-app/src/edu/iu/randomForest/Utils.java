...
public class Utils {
	...
	private static boolean testDataWritten = false;
	...
	private static void writeTrainData(String trainDatasetPath, Path trainDataDir, int numMapTasks, FileSystem fs) throws IOException{
		...
		//String[] columns = null;
		int i = 0;
		int class0Lines=0, class1Lines = 0;
...
//		}
		...
		try{
			...
			while((line = br.readLine()) != null) {
				...
				if(!data[data.length-1].equals("CLASS")){
	...
	private static int getFileIndex(String classLabel) {
		...
		//System.err.println("Writing: "+classL);
